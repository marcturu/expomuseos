            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div style="text-align: center; margin-top: 2rem; margin-bottom: 2rem;">
                    <p style="text-align: center; font-size: 1.25rem; margin-bottom: 1.5rem;">
                        ¡Nos alegramos de volverte a ver, <strong><?php echo e(auth()->user()->name); ?></strong>!
                    </p>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\dbphppec4_museums\resources\views/dashboard.blade.php ENDPATH**/ ?>